...
const BookingRoom = () => {
    ...
    const room_type = (type) => {
        ...
        history.push("/booking/rooms/confirmation");
    };
        ...
        <div class="rooms">
            ...
            <div class="chooseRooms">
                ...
                <div class="room1">
                    ...
                    <div class="room1_box">
                        <img src={crown} width="100px" height="100px"></img>
                        <p>Business Suite</p>
                        <div></div>
                        <p>
